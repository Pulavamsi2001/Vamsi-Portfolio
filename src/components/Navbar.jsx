...
const Navbar = () => {
  ...
  return (
    <nav className='fixed w-full bg-gray-900 text-gray-100 py-4 px-6 z-50'>
      ...
      <div ref={menuRef} className={`md:hidden absolute top-16 right-0 bg-gray-800 w-2/5 rounded-lg shadow-lg transition-transform duration-300 ease-in-out transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
